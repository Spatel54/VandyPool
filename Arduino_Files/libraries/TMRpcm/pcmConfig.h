...
#define buffSize 128  //must be an even number FIXME UNCOMMENTED
...
//#define rampMega
   ...
   Depending on the card, can take a few seconds for recording to start
   																									*/
#define ENABLE_RECORDING // FIXME I UNCOMMENTED THIS
	// Amount of space to pre-allocate for recording
#define BLOCK_COUNT 10000UL  // 10000 = 500MB   2000 = 100MB FIXME I UNCOMMENTED
